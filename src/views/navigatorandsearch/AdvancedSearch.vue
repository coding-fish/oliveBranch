          ...
          <dl>
            ...
            <dd>
              ...
              <el-input placeholder="请输入关键词" v-model="input1" style="width: 60% ">
                <el-select v-model="select1" slot="prepend" placeholder="请选择" class="object_select"
                           style="width: 140px;">
            ...
            <el-button slot="append" icon="el-icon-search" @click="search_click()"
                       v-loading.fullscreen.lock="fullscreenLoading">检索
            </el-button>
                  ...
                  <el-col :span="24" style="margin-top: 1rem; text-align: left"
                    ...
                    <el-card class="box-card" shadow="always">
                      <div class="text item">
                        ...
                        <el-col :span="24" style="margin-bottom: 1rem">
                          <span
                              v-if="typeof(item.h_index)!=='undefined'&&item.h_index!==''">h指数：{{ item.h_index }}</span>
                        ...
                        <el-col :span="24" style="margin-bottom: 1rem">
                          <span
                              v-if="typeof(item.n_citation)!=='undefined'&&item.n_citation!==''">被引量：{{ item.n_citation }}</span>
                          <span v-else>被引量：未知</span>
                        </el-col>
                        <el-col :span="24" style="margin-bottom: 1rem">
                          <span
                              v-if="typeof(item.orgs)!=='undefined'&&item.orgs!==''&&item.orgs[0]!==''">工作单位：{{ item.orgs[0] }}</span>
                  ...
                  <el-col style="margin-top: 1rem; text-align: left">
                    ...
                    <el-form :inline="true" :model="formInline" class="demo-form-inline" style="margin-top:2rem">
                      <el-form-item label="起始年限">
                        ...
                        <el-input-number v-model="min_num" @change="search_start(min_num)" :min="1800" :max="2020"
                                         label="起始年限"></el-input-number>
                      </el-form-item>
                      <el-form-item label="结束年限">
                        ...
                        <el-input-number v-model="max_num" @change="search_end(max_num)" :min="1800" :max="2020"
                                         label="结束年限"></el-input-number>
                      </el-form-item>
                      <el-form-item>
                  ...
                  <el-col :span="24" style="margin-top: 1rem; text-align: left"
                    ...
                    <el-card class="box-card" shadow="always">
                      <div class="text item">
                        ...
                        <el-col :span="24" style="margin-bottom: 1rem">
                          <span
                              v-if="typeof(item.venue_name)!=='undefined'&&item.venue_name!==''">发表刊物：{{ item.venue_name }}</span>
...
export default {
  ...
  data() {
    return {
      ...
      subject1: [{
        value1: '选项1', label1: '作者', disabled: false
      }, {
      ...
      subject_i1: [{
        value3: '选项1', label3: '精确'
      }, {
        value3: '选项2', label3: '模糊'
      }],
      subject_i2: [{
        value4: '选项1', label4: '精确'
      }, {
