  ...
  <div>
    ...
    <div class="router">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="16">
          <div>
            <p style="color:gray;font-size:8px;margin-bottom:20px;margin-left:20px" v-show="get&&list.length>0">
              总共{{ list.length }}条搜索记录</p>
                ...
                <el-card class="box-card">
                  <div slot="header">
                    <el-link class="blog-title" :underline="false" :href="'/BlogItem/'+item.userid+'/'+item.blogid"
                      ...
                      <h2 style="font-size:20px;margin-top:-6px;;margin-bottom:-6px;justify-content:left">
                        {{ item.blogname }}</h2>
                    </el-link>
                    <p style="margin-top:10px;font-size:15px;width:90%;padding-left:15px;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 3;overflow: hidden;">
                      {{ item.textcontent }}</p>
                  </div>
                  <div class="flex6" style="font-size:12px;color:gray">
                    ...
                    <span style="margin-right:20px;color:gray">作者
                          <el-link class="blog-title" :underline="false" :href="'/userinfo/'+item.userid"
                                   style="font-size:15px;margin-top:-3px">{{ item.username }}</el-link></span>
